   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post">
            ...
            <a href="seller_orders.php?delete=<?php echo $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">delete</a>
         </form>
      </div>
      <?php
         }
